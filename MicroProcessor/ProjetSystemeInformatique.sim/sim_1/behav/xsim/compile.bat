...
REM
REM Generated by Vivado on Sat Apr 11 11:31:55 +0200 2026
...
echo "xvhdl --incr --relax -prj ALUTb_vhdl.prj"
call xvhdl  --incr --relax -prj ALUTb_vhdl.prj -log xvhdl.log
