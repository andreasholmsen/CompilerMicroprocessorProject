...
static const char *const yytname[] =
{
  ...
  "tERROR", "tNUM", "tID", "$accept", "Program", "Line", "Term", "Expr",
  "Assignment", "Declaration", YY_NULLPTR
};
...
{
      12,    -8,     2,   -18,    15,     0,   -18,    14,    20,    27,
       4,   -18,   -18,   -18,   -18,    -3,     4,   -18,   -18,   -18,
     -18,     4,    30,     7,     7,     7,     7,   -18,    36,    36,
     -18,   -18,   -18,   -18,   -18
};
...
{
       0,     0,     0,     8,     0,     0,     2,     0,     0,     0,
       0,     5,     9,    10,    11,     0,     0,     1,     3,     4,
       6,     0,     0,     0,     0,     0,     0,     7,    17,    18,
      16,    12,    13,    14,    15
};
...
{
      17,    23,    24,    25,    26,    22,    31,    32,    33,    34,
      10,    28,    10,     9,     1,    27,    29,     2,    16,     3,
      11,     4,    12,    13,    12,    13,     1,    12,    13,     2,
      21,     3,    19,     4,    23,    24,    25,    26,    20,    30,
      23,    24,    25,    26,    18
};

static const yytype_int8 yycheck[] =
{
       0,     4,     5,     6,     7,    10,    23,    24,    25,    26,
       8,    16,     8,    21,    14,    18,    21,    17,     3,    19,
      18,    21,    20,    21,    20,    21,    14,    20,    21,    17,
       3,    19,    18,    21,     4,     5,     6,     7,    18,     9,
       4,     5,     6,     7,     5
};
...
{
       0,    14,    17,    19,    21,    23,    24,    27,    28,    21,
       8,    18,    20,    21,    25,    26,     3,     0,    24,    18,
      18,     3,    26,     4,     5,     6,     7,    18,    26,    26,
       9,    25,    25,    25,    25
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* Line: Assignment tSEMIC  */
#line 32 "parser.y"
                            {;}
#line 1110 "parser.tab.c"
    break;

  case 5: /* Line: tPRINTF tSEMIC  */
#line 33 "parser.y"
                         {printf("testing\n");}
#line 1116 "parser.tab.c"
    break;

  case 6: /* Line: Declaration tSEMIC  */
#line 34 "parser.y"
                             {;}
#line 1122 "parser.tab.c"
    break;

  case 7: /* Line: tPRINTF Expr tSEMIC  */
#line 35 "parser.y"
                              {printf("%d\n", (yyvsp[-1].nb));}
...
#line 1152 "parser.tab.c"
  ...
  case 12: /* Expr: Expr tPLUS Term  */
#line 44 "parser.y"
                          { (yyval.nb) = (yyvsp[-2].nb) + (yyvsp[0].nb); }
#line 1158 "parser.tab.c"
    break;

  case 13: /* Expr: Expr tMINUS Term  */
#line 45 "parser.y"
                           { (yyval.nb) = (yyvsp[-2].nb) - (yyvsp[0].nb); }
#line 1164 "parser.tab.c"
    break;

  case 14: /* Expr: Expr tMULT Term  */
#line 46 "parser.y"
                          {(yyval.nb) = (yyvsp[-2].nb) * (yyvsp[0].nb);}
#line 1170 "parser.tab.c"
    break;

  case 15: /* Expr: Expr tDIV Term  */
#line 47 "parser.y"
                         {(yyval.nb)= (yyvsp[-2].nb) / (yyvsp[0].nb);}
#line 1176 "parser.tab.c"
    break;

  case 16: /* Expr: tOPAR Expr tCPAR  */
#line 48 "parser.y"
                           { (yyval.nb) = (yyvsp[-1].nb);}
#line 1182 "parser.tab.c"
    break;

  case 17: /* Assignment: tID tEQ Expr  */
#line 52 "parser.y"
                       {addSymbol((yyvsp[-2].var), (yyvsp[0].nb));}
#line 1188 "parser.tab.c"
    break;

  case 18: /* Declaration: tINT tID tEQ Expr  */
#line 56 "parser.y"
                            { addSymbol((yyvsp[-2].var), (yyvsp[0].nb)); }
